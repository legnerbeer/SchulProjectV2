...
class BMP280:
    def __init__(self, i2c_bus, addr=0x76, sea_level_pressure = 101325.0, use_case=BMP280_CASE_HANDHELD_DYN):
        self._bmp_i2c = i2c_bus
        self._i2c_addr = addr
        self.sea_level_pressure = sea_level_pressure  # default, kann geändert werden
    ...
    @property
    def altitude(self):
        """Gibt die berechnete Höhe (m) anhand self.sea_level_pressure zurück."""
        p = self.pressure*100
        return 44330.0 * (1.0 - (p / self.sea_level_pressure) ** (1.0 / 5.255))
